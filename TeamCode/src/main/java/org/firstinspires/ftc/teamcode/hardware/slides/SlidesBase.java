...
public class SlidesBase extends HardwareBase {
    ...
    public void verticalSlidesControls(double rightTrigger, double leftTrigger, int vertPos, boolean option) {
    ...
    public void horizSlidesControls(boolean leftBumper, boolean rightBumper, int horizPos, boolean option) {
        //code that uses the pidf to do cool sigma stuff
        //reversing Y cuz im like pretty sure thats how it is
